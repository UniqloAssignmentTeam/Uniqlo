    ...
    <div class="productBody">
        ...
        <div class="dropdown-bigcontainer">
            ...
            <div style="display: flex;">
                ...
                <div class="dropdown-container" onclick="toggleDropdown('dropdownList5', 'dropdownDisplay5')">
                 ...
                 <div class="dropdown-container" onclick="toggleDropdown('dropdownList3', 'dropdownDisplay3')" style="margin-left:15px;">
     ...
     <div class="dropdown-list" id="dropdownList3">
         ...
         <div onclick="selectOption('Men', 'dropdownDisplay2')">Men</div>
                  ...
                  <div class="dropdown-container" onclick="toggleDropdown('dropdownList4', 'dropdownDisplay4')" style="margin-left: 475px;">
      <div class="dropdown-display" id="dropdownDisplay4">All</div>
